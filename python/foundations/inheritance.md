...
* Using the `Human` class defined in [classes.md](https://github.com/kde6260/Today-I-Learned/blob/master/python/foundations/classes.md#learn-x-in-y-minutes) 
as the base or parent class, we can define a child class, `Superhero`, which inherits the class variables like "species", "name", and "age", as well as methods, 
like "sing" and "grunt" from the `Human` class, but can also have its own unique properties.
* To take advantage of modularization by file you could place the classes above in their own files, say, `human.py`

* To import functions from other files use the following format from 
`filename_without_extension" import function_or_class` from human import Human
